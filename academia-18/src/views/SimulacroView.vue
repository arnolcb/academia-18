        ...
        <div class="simulacro-card">
          ...
          <div class="info-simulacro">
            ...
            <div class="info-item">
              ...
              <span>Puntuación: 4 puntos por respuesta correcta</span>
            </div>
          </div>
          <div class="instrucciones">
            <h3>Instrucciones:</h3>
            <ul>
              <li>El simulacro tiene una duración de 70 minutos.</li>
...
const cargarSimulacro = async () => {
  ...
  try {
    ...
    const preguntasRef = collection(db, `simulacros/${simulacroId}/preguntas`);
    //const q = query(preguntasRef, orderBy('orden', 'asc')); // Ordenar por el campo 'orden'
    //const preguntasSnapshot = await getDocs(preguntasRef);

    const q = query(preguntasRef, orderBy('orden', 'asc')); // Descomenta esta línea
    ...
    // Barajar las preguntas para tener un orden aleatorio
    //preguntas.value = barajarArray(preguntasTemp).slice(0, simulacro.value.totalPreguntas);
