<template>
  <section class="matricula-form">
    ...
    <h2 class="form-title">Matrícula VIP</h2>
    <p class="form-subtitle">Completa tus datos para acceder a una experiencia educativa personalizada</p>
      ...
      <div class="form-group">
        <div class="floating-input">
          <input
            ...
            required
          />
          <label for="correo" :class="{ active: formData.correo }"
      ...
      <div class="form-group">
        <div class="floating-input floating-select">
          <select id="modalidad" v-model="formData.modalidad" required>
            ...
            <option value="Postular a una Universidad">Postular a una Universidad</option>
          ...
          <label for="modalidad" :class="{ active: formData.modalidad }"
            >Te estás preparando para</label
          >
        </div>
      </div>
...
const handleSubmit = async () => {
  const url =
    "https://script.google.com/macros/s/AKfycbx6tv3zfGvbCWxH4G4DLsDa1m8b8J0pTcgRk6rtdpouW_Kb8joeJGXiq9Ik3xAYrDBdUA/exec";
