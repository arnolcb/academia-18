      ...
      <div v-else class="dashboard-main-wrapper">
        ...
        <div v-if="!esUsuarioVip" class="vip-no-access-full">
          <div class="vip-no-access-card">
            ...
            <p>El Aula Virtual está disponible solo para estudiantes VIP seleccionados. Contacta con tu instructor para más información sobre cómo obtener acceso a contenido exclusivo y materiales premium.</p>
